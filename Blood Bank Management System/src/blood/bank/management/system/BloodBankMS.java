...
public class BloodBankMS{
    ...
    public static void main(String[] args){
        ...
        hospital[1] = new Hospital("Selangor", "Selayang Hospital               ", "Public ", new BloodBank());
        hospital[2] = new Hospital("Selangor", "Pusrawi Hospital               ", "Public ", new BloodBank());
        hospital[3] = new Hospital("Selangor", "Banting Hospital                ", "Public", new BloodBank());
        hospital[4] = new Hospital("Penang   ", "Island Hospital                   ", "Private ", new BloodBank());
        hospital[5] = new Hospital("Johor   ", "Columbia Asia Hospital        ", "Private", new BloodBank());
        hospital[6] = new Hospital("Selangor  ", "KPJ Kajang Specialist Hospital", "Private", new BloodBank());
        ...
        user[2] = new Donor("mary", "stethometer", "Fatimah", "F", 98, 24.1f, "A+", hospital[0], 2, 1, 12);
        user[3] = new Donor("shaz", "materteral", "Teow Fei", "F", 67, 45.1f, "B+", hospital[0], 2, 1, 12);
        user[4] = new Donor("carr", "muciferous", "Lois David", "F", 76, 75.1f, "AB+", hospital[0], 2, 1, 12);
        user[5] = new Donor("izz", "windbound", "Luqman", "M", 84, 68.1f, "O+", hospital[0], 2, 1, 12);
        user[6] = new Donor("letchum", "vespertilian", "Nalla", "F", 66, 45.1f, "A-", hospital[0], 2, 1, 12);
        user[7] = new Donor("jane", "hygiology", "Janet", "F", 34, 45.1f, "O-", hospital[0], 2, 1, 12);
        user[8] = new Donor("hender", "killock", "Sten Lee", "M", 47, 45.1f, "B-", hospital[0], 2, 1, 12);
        user[9] = new Donor("teresa", "hypolimnion", "Hasine Miku", "F", 76, 45.1f, "AB-", hospital[0], 2, 1, 12);
        ...
        user[13] = new Donor("tehah", "ontography", "Zakharia Chan", "F", 67, 45.1f, "O-", hospital[0], 2, 1, 12);
        ...
        if(chosenHospital==1){
            user[0].getHospital().setName("Selayang Hospital               ");}
        else if(chosenHospital==2){
            user[0].getHospital().setName("Pusrawi Hospital               ");}
        else if(chosenHospital==3){
            user[0].getHospital().setName("Banting Hospital");}
        ...
        if(userChoice=='A'){
            ...
            donor.setLastWeekDonate(input.nextInt());
            ...
            System.out.println("\nEligibility         : " +donor.checkEligibility());
        }
